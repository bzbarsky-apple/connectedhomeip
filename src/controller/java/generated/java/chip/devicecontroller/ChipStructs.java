...
public static class UnitTestingClusterSimpleStruct {
  ...
  public StructType encodeTlv() {
    ...
    values.add(new StructElement(I_ID, i.<BaseTLVType>map((nonOptionali) -> new AnyType(nonOptionali)).orElse(new EmptyType())));
  ...
  public static UnitTestingClusterSimpleStruct decodeTlv(BaseTLVType tlvValue) {
    ...
    Float g = null;
    Double h = null;
    Optional<Object> i = Optional.empty();
    for (StructElement element: ((StructType)tlvValue).value()) {
      if (element.contextTagNum() == A_ID) {
        ...
        if (element.value(BaseTLVType.class).type() == TLVType.Any) {
          ...
          i = Optional.of(castingValue.value(Object.class));
        }
      }
    }
...
public static class UnitTestingClusterNestedStruct {
  ...
  public StructType encodeTlv() {
    ...
    values.add(new StructElement(D_ID, d.<BaseTLVType>map((nonOptionald) -> new AnyType(nonOptionald)).orElse(new EmptyType())));
  ...
  public static UnitTestingClusterNestedStruct decodeTlv(BaseTLVType tlvValue) {
    ...
    for (StructElement element: ((StructType)tlvValue).value()) {
      if (element.contextTagNum() == A_ID) {
        ...
        if (element.value(BaseTLVType.class).type() == TLVType.Any) {
          AnyType castingValue = element.value(AnyType.class);
          d = Optional.of(castingValue.value(Object.class));
        }
      }
    }
